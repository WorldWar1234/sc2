...
const MIN_COMPRESS_LENGTH = 512; // Minimum size in bytes for compressing WebP images
const MIN_TRANSPARENT_COMPRESS_LENGTH = MIN_COMPRESS_LENGTH * 100; // Minimum size for PNG and GIF images
